...
def get_simple_coarse_voxel_part_color(voxels, segmentations, color_maps):
        ...
        for j in range(0, dimy):
            for k in range(0, dimz):
                ...
                if i > 0 and voxels[i - 1, j, k] == 0 or i <= 0:
                    ...
                    all_colors[all_vertices_len, :] = color_maps[segmentations[i, j, k]]
                    all_vertices_len += 1
                    all_vertices[all_vertices_len, 0] = i
    ...
    return all_vertices[:all_vertices_len], all_triangles[:all_triangles_len], all_colors[:all_vertices_len], all_normals[:all_triangles_len]
