...
# 16 -> 32 -> 64 -> 128
class pyramid_generator_shaddr_x16_wo_parts(nn.Module):
    def __init__(self, g_dim, prob_dim, z_dim):
        super(pyramid_generator_shaddr_x16_wo_parts, self).__init__()
        self.g_dim = g_dim
        self.prob_dim = prob_dim
        self.z_dim = z_dim
        ...
        # 128 -> 256
        self.conv_40 = nn.ConvTranspose3d(self.g_dim * 2 + self.z_dim,     self.g_dim * 1,  4, stride=2, padding=1, bias=True)
        self.conv_o4 = nn.Conv3d(self.g_dim * 1,                           1,               3, stride=1, padding=1, bias=True)
